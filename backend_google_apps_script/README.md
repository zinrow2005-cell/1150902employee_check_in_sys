# Apps Script｜W430 FIX366 CLEAN

正式員工自助中心橋接版本：`W430_FIX366_CLEAN`
...
5. GitHub 端「測試橋接」應回傳版本 `W430_FIX366_CLEAN`。
...
- FIX366：新增 `roster_change` 休假日期調整申請；只保存申請，正式班表由主系統核准後回傳。
