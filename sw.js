// W433 FIX369 CLEAN
const CACHE='wts-employee-portal-current-20260905-fix369';
const ASSETS=['./','index.html','style.css?v=433369','app.js?v=433369','config.js?v=433369','manifest.webmanifest','assets/wts-logo-original.png'];
