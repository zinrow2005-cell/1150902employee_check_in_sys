// W412 FIX348
const CACHE='wts-attendance-fix348-v1';
const ASSETS=['./','index.html','style.css?v=348','app.js?v=348','config.js?v=348','manifest.webmanifest','assets/wts-logo-original.png'];
