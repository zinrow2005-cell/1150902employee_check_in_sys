// W456 FIX392-R4
const CACHE='wts-employee-portal-current-20260908-fix392-r4';
const ASSETS=['./','index.html','style.css?v=4563924','app.js?v=4563924','config.js?v=4563924','manifest.webmanifest','assets/wts-logo-original.png','assets/wts-name-handwritten-white.png'];
