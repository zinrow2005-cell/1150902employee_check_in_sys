// W417 FIX353
const CACHE='wts-employee-portal-fix353-v1';
const ASSETS=['./','index.html','style.css?v=353','app.js?v=353','config.js?v=353','manifest.webmanifest','assets/wts-logo-original.png'];
