// W431 FIX367 CLEAN
const CACHE='wts-employee-portal-current-20260905-fix367';
const ASSETS=['./','index.html','style.css?v=431367','app.js?v=431367','config.js?v=431367','manifest.webmanifest','assets/wts-logo-original.png'];
