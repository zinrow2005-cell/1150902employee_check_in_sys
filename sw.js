// W406 compatibility marker: wts-attendance-fix342-v1
const CACHE='wts-attendance-fix344-v1';
const ASSETS=['./','index.html','style.css?v=344','app.js?v=344','config.js?v=344','manifest.webmanifest','assets/wts-logo-original.png'];
