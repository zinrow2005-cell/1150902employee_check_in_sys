// W427 FIX363 CLEAN
const CACHE='wts-employee-portal-current-20260905-fix363';
const ASSETS=['./','index.html','style.css?v=427363','app.js?v=427363','config.js?v=427363','manifest.webmanifest','assets/wts-logo-original.png'];
