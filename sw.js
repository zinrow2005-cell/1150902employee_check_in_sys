const CACHE='wts-attendance-fix337-v1';
const ASSETS=['./','index.html','style.css?v=337','app.js?v=337','config.js?v=337','manifest.webmanifest','assets/wts-logo-original.png'];
