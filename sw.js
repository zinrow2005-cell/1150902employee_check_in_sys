// W456 FIX392-R5
const CACHE='wts-employee-portal-current-20260908-fix392-r5';
const ASSETS=['./','index.html','style.css?v=4563925','app.js?v=4563925','config.js?v=4563925','manifest.webmanifest','assets/wts-logo-original.png','assets/wts-name-handwritten-white.png'];
