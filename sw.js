// W430 FIX366 CLEAN
const CACHE='wts-employee-portal-current-20260905-fix366';
const ASSETS=['./','index.html','style.css?v=430366','app.js?v=430366','config.js?v=430366','manifest.webmanifest','assets/wts-logo-original.png'];
