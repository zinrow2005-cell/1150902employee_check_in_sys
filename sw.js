// W456 FIX392-R2
const CACHE='wts-employee-portal-current-20260908-fix392-r2';
const ASSETS=['./','index.html','style.css?v=4563922','app.js?v=4563922','config.js?v=4563922','manifest.webmanifest','assets/wts-logo-original.png','assets/wts-name-handwritten-white.png'];
