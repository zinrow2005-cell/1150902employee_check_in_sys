// W456 FIX392-R1
const CACHE='wts-employee-portal-current-20260908-fix392-r1';
const ASSETS=['./','index.html','style.css?v=4563921','app.js?v=4563921','config.js?v=4563921','manifest.webmanifest','assets/wts-logo-original.png','assets/wts-name-handwritten-white.png'];
