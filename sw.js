const CACHE='wts-attendance-fix342-v1';
const ASSETS=['./','index.html','style.css?v=342','app.js?v=342','config.js?v=342','manifest.webmanifest','assets/wts-logo-original.png'];
