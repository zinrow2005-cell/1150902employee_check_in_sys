const CACHE='wts-attendance-fix341-v1';
const ASSETS=['./','index.html','style.css?v=341','app.js?v=341','config.js?v=341','manifest.webmanifest','assets/wts-logo-original.png'];
