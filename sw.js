// W410 FIX346
const CACHE='wts-attendance-fix346-v1';
const ASSETS=['./','index.html','style.css?v=346','app.js?v=346','config.js?v=346','manifest.webmanifest','assets/wts-logo-original.png'];
